      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10 max-w-6xl">
        ...
        <div className="text-center mb-16">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/10 border border-white/20 mb-6 backdrop-blur-sm">
            ...
            <span className="text-sm font-medium text-white">Personlig Strategi</span>
          </div>
            ...
            <CardContent className="p-6 md:p-8">
              <div className="space-y-6">
                ...
                <div className="flex items-center gap-4 pb-4 border-b border-white/10">
                  ...
                  <div>
                    <div className="font-bold text-lg text-white">Ditt Dashboard</div>
                    <div className="text-sm text-white/60">Instagram Analys</div>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="p-5 rounded-xl bg-white/5 border border-white/10">
                    ...
                    <div className="text-sm text-white/60 mt-1">Visningar</div>
                  </div>
                  <div className="p-5 rounded-xl bg-white/5 border border-white/10">
                    <div className="text-3xl font-bold text-gradient">8.2%</div>
                    <div className="text-sm text-white/60 mt-1">Engagemang</div>
                  </div>
                </div>
