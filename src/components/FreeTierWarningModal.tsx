      ...
      <DialogContent className="max-w-md">
        <DialogHeader>
          <DialogTitle className="flex items-center gap-2">
            ...
            Gratis plan – begränsad användning
          </DialogTitle>
          <DialogDescription>
            Du kan använda <strong>antingen</strong> en AI-analys <strong>eller</strong> en AI-kalender per månad på gratis planen.
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="space-y-4">
          <div className="grid grid-cols-2 gap-3">
            <div className={`rounded-xl border p-3 text-center ${usageType === "ai_analysis" ? "border-primary bg-primary/5" : "border-border"}`}>
              ...
              <p className="text-xs font-medium">AI-Analys</p>
            </div>
            <div className={`rounded-xl border p-3 text-center ${usageType === "calendar" ? "border-primary bg-primary/5" : "border-border"}`}>
              ...
              <p className="text-xs font-medium">AI-Kalender</p>
            </div>
          </div>

          <p className="text-sm text-muted-foreground">
            Du väljer nu att använda din månatliga kvot på{" "}
            <strong>{usageType === "ai_analysis" ? "AI-analys" : "AI-kalender"}</strong>.
            Du kommer inte kunna använda den andra förrän nästa månad.
          </p>
          ...
          {loadingRec ? (
            <div className="flex items-center gap-2 text-xs text-muted-foreground bg-muted/50 rounded-lg p-3">
              ...
              AI analyserar vad som passar dig bäst...
            </div>
          ) : aiRecommendation ? (
            <div className="bg-muted/50 rounded-lg p-3 border border-border/50">
              <div className="flex items-center gap-1.5 mb-1">
                <Sparkles className="w-3.5 h-3.5 text-primary" />
                <span className="text-xs font-medium">AI-rekommendation</span>
              </div>
